    ...
    return (
        <div id = "Home" className = 'hero'>
            ...
            <div className = "hero-action">
                <a href="" target="_blank" rel="noopener noreferrer" className="hero_github">
                    Github
                </a>
                <a href="" target="_blank" rel="noopener noreferrer" className="hero_Linkdin">
                    Linkedin
                </a>
                <a href="" target="_blank" rel="noopener noreferrer" className="hero_Instagram">
                    Instagram
                </a>
                <a href="" target="_blank" rel="noopener noreferrer" className="hero_Resume">
                    Resume
                </a>
            </div>
        </div>
